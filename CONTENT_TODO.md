...
- [x] Create and share the 3 Regular Sim, 1 Pro Sim, 2 PS5 Lounge, and Booking Control calendars (created in the Xerom Booking Google account on 2026-09-13; coordinator granted Make changes / see private events as free/busy).
...
- [ ] Create/configure the Cloudflare Turnstile widget and store its production secret; the booking-coordinator Worker was created and deployed on 2026-09-13.
